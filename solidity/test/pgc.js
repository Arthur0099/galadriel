...
const PGCVerifier = artifacts.require("PGCVerifier");
...
contract("pgc", function(account){
  before(async function(){
    ...
    this.PGCVerifierIns = await PGCVerifier.new(this.PublicParamsIns.address, this.PublicParamsIns.address, this.PublicParamsIns.address, this.PublicParamsIns.address);
    this.TokenConverterIns = await TokenConverter.new();

    this.PGCIns = await PGC.new(this.PublicParamsIns.address, this.PGCVerifierIns.address, this.TokenConverterIns.address);
  });

  it("simple t", async function(){
    await this.PGCIns.ccc();
  })
